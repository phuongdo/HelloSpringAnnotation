...
public abstract class MQTTCommunicationHandler
    ...
    protected MQTTCommunicationHandler(String deviceOwner, String deviceType,
        ...
        this.clientId = deviceOwner + ":" + deviceType;
        this.subscribeTopic = subscribeTopic;
        this.clientWillTopic = "gone-offline";//deviceType + File.separator + "disconnection";
        this.mqttBrokerEndPoint = mqttBrokerEndPoint;
        this.timeoutInterval = intervalInMillis;

        //System.out.println("MQTT subscriber was created with ClientID : " + clientId);
        this.initSubscriber();
    }
    ...
    private void initSubscriber() {
        try {
//            System.out.println("MQTT subscriber was created with ClientID : " + mqttBrokerEndPoint);
        ...
        options.setWill(clientWillTopic, "Connection-Lost".getBytes(), 2,
                true);
//        System.out.println("....");
//        try {
