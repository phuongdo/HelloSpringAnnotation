...
//        factory.setRecordFilterStrategy(record -> record.value().contains("World"));
        factory.setRecordFilterStrategy(new RecordFilterImpl());
        return factory;
    }
    ...
    public ConsumerFactory<String, Greeting> greetingConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<String, Greeting>(props, new StringDeserializer(), new JsonDeserializer(Greeting.class));
    }
